...
\begin{definition}[Non-Triviality]\label{def:non-triviality}
	An inference $ \Gamma \vdash \Delta $ is \textit{non-trivial} if and only if it is defeasible, premise-consistent, and irreflexive.
\end{definition}
